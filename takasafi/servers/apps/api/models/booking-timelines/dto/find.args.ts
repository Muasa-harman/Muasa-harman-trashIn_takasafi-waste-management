...
import { BookingTimelineWhereUniqueInput,BookingTimelineWhereInput} from "./where.args";
...
@ArgsType()
class FindManyBookingTimelineArgsStrict implements RestrictProperties<FindManyBookingTimelineArgsStrict,Omit<Prisma.BookingTimelineFindManyArgs, 'include' | 'select'>>{
