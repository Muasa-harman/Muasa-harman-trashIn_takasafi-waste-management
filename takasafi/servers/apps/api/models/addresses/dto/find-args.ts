...
@ArgsType()
class FindManyAddressArgsStrict implements RestrictProperties<FindManyAddressArgsStrict,Omit<Prisma.AddressFindManyArgs, 'include' | 'select'>>{
    where: AddressWhereInput
    orderBy:AddressOrderByWithRelationInput[]
    cursor:AddressWhereUniqueInput
    take:number
    skip:number
    @Field(()=>[Prisma.AvatarsScalarFieldEnum])
